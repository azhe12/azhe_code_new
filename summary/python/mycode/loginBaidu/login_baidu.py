...
req_baidu = urllib2.urlopen(url_baidu)
show_cookie(cj)
...
req_getApi = urllib2.urlopen(url_getApi)

req_str = req_getApi.read()
print 'responce body = \n', req_str
...
username = 'liuyuanzhe123@126.com'
passwd = 'lyz13.BAIDU'
...
req = urllib2.Request(url_login, post_data, header) #发送POST请求
